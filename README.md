...
| SES delivery                                                      | Sandbox pilot verified     | Sender and pilot recipients are verified; a fresh neutral household-A message reached Gmail, household B remained suppressed, and the earlier ambiguous attempt remains held `unknown` without replay |
