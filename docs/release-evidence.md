...
| Clean CI                   | Public GitHub Actions run on the submitted commit                                                           | Pending first public workflow run                |
| CDK                        | `cdk synth --strict`, cdk-nag report, reviewed `cdk diff`                                                   | Strict synth passed; diff blocked on AWS login   |
