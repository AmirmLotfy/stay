...
- [x] Publish `assets/submission/video/STAY_DEMO.en.srt` as a separate manual English track. Studio and the public player show manual English selected separately from the retained auto-generated track; the approved opening cue renders and an uninterrupted public pass reached 2:50 with synchronized text visible at 1:01 and 2:01.
- [ ] Participant manually reviews all 36 published cues against the mixed master with sound. Technical cue validation and public stream/caption continuity have passed; this listening/content judgment remains participant-owned.
