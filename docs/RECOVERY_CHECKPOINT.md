...
- Fresh public caption check on 2026-09-08: the YouTube player settings list manual **English** and **English (auto-generated)** as separate tracks, with manual English selected. The approved opening cue, `[Soft felt-piano and marimba music]`, renders visibly. YouTube's CC checkbox retains an incorrect “unavailable” accessibility description even while its value is on and the manual track is displayed; rely on the visible track menu and cue, and keep the complete human playback gate open.
