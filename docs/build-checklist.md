...
- [x] Correct the eligibility answers, replace YouTube's automatic captions with the packaged SRT, paste the reviewed fields, and complete Devpost's final confirmation. The copyright-claim review passed.
- [ ] Participant watches the complete public video with sound and manual captions and accepts the final content.
