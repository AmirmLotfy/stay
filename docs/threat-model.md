...
| Threat                              | Control                                                                                                                 |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Cross-household access              | Household comes from verified JWT claims; clients never submit an authoritative household ID                            |
| Demo-to-real data access            | Separate TTL namespace and unauthenticated route; demo fixtures cannot query authenticated partitions                   |
